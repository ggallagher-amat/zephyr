.. zephyr:board:: ensemble_e7_dk

Overview
********

The Alif Ensemble E7 Development Kit is a single-board development
platform that can be configured to operate with the E3, E5, or E7 series devices
...
The Ensemble E7 Development Kit provides different hardware components including:
